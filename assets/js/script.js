...
function generateCurrentWeather() {
  ...
  else if (weatherCurrent.uvi > 3 && weatherCurrent.uvi < 6)  uviEl.addClass("meduvi");
  else if (weatherCurrent.uvi > 6 && weatherCurrent.uvi < 8)  uviEl.addClass("moderateuvi");
  else if (weatherCurrent.uvi > 8 && weatherCurrent.uvi < 11) uviEl.addClass("highuvi");
...
function generateForecastCard() {
    ...
    for(var day = 0; day < 5; day++){
        ...
        $(`#day-${day}`).append(
            `<h1>
              ${moment().add(day+1, "day").format("dddd")}
            </h1>
            <p id=futureWeather>
